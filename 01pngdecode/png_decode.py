...
print("bitd : {}".format(bitd))
print("colort : {}".format(colort))
print("compm : {}".format(compm))
print("filterm : {}".format(filterm))
print("interlacem : {}".format(interlacem))
# exit()
if compm != 0:
...
IDAT_data = zlib.decompress(IDAT_data)#解压 --> 解压数据

print("IDAT_data : {}".format(len(IDAT_data))) #IDAT_data = width * height * len(R,G,B,A) + height
...
print("Recon length : {}".format(len(Recon))) # height * weight * len(R,G,B,A)
